...
const FAQS = [
  {
    ...
    a: "はい。本番を想定した10種類のケースで繰り返し練習できるため、実際の面接試験に近い感覚を身につけられます。また試験の4区分評価（態度・展開・見立て・具体的展開）に沿ったフィードバックにより、自分の弱点を客観的に把握できます。",
  },
  {
    q: "どんなケースが用意されていますか？",
    a: "転職・キャリアチェンジ・職場の人間関係・将来への不安など、実際の試験で出題されやすいテーマを10種類用意しています。いずれも2級の実技試験を想定したシナリオです。",
  },
  {
    q: "スマートフォンでも使えますか？",
            ...
            {[
              {
                icon: "🎭",
                title: "本番想定のロールプレイ",
                desc: "転職・職場の悩みなど実際の試験に出やすい10種類のケースでAIクライアントと面接練習。",
                color: "#eff6ff",
                border: "#bfdbfe",
              },
              {
      ...
      <section style={{ background: "#f8fafc", padding: "72px 20px" }}>
        <div style={{ maxWidth: 680, margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 0 }}>
            {[
              { step: "01", title: "ケースを選ぶ", desc: "10種類のケースから練習したいシナリオを選択します。どのケースも実際の試験を想定したシナリオです。" },
